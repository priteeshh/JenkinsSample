...
def xcodeproj = 'JenkinProject.xcodeproj' // Path to the xcodeproj
def xcarchive_name = "JenkinProject.xcarchive" // Name of the archive to build
def build_scheme = 'JenkinProject' // Scheme to build the app
def test_scheme = 'JenkinProject' // Scheme to build tests
